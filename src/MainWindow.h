...
namespace src {
    ...
    private: 
        ...
        String^ nameDBMS1; String^ Server1; String^ DataBase1; String^ User1; String^ Driver1; String^ tableInput1; String^ tableOutput1; String^ columnInputId1; String^ columnOutputId1;
        String^ nameDBMS2; String^ Server2; String^ DataBase2; String^ User2; String^ Driver2; String^ tableInput2; String^ tableOutput2; String^ columnInputId2; String^ columnOutputId2;
        String^ dataIn1; String^ dataIn2; String^ dataIn3; String^ dataOut1; String^ dataOut2; String^ dataOut3;
        String^ nameDB1;
        String^ nameUser1;
        String^ nameUser2;
        String^ nameDB2;
...
#pragma endregion
        ...
        private: System::Void btnConfirmID_Click(System::Object^ sender, System::EventArgs^ e);
        private: System::Void btnAddRecords_Click(System::Object^ sender, System::EventArgs^ e);
